    ...
    public partial class TFrmSelectBankStatement
    {
        ...
        private void DeleteStatement(object sender, EventArgs e)
        {
            ...
            if (SelectedGridRow.Length >= 1)
            {
                ...
                {
                    if (FPluginRemote.WebConnectors.DropBankStatement(toDelete.StatementKey))
                    {
                        PopulateStatementGrid(null, null);
                    }
                }
        ...
        private void TrainBankStatementsLastMonth()
        {
            FPluginRemote.WebConnectors.TrainBankStatementsLastMonth(FLedgerNumber, DateTime.Today);
        }
